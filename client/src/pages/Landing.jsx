    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-[1200px] mx-auto">
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="bg-[#3451ff] text-white px-4 py-2 rounded text-[13px] font-medium hover:bg-[#2b41e6] transition-colors">
            Get started
          </Link>
        </div>
      </nav>
      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-24 pb-20 lg:pt-32 lg:pb-28 grid lg:grid-cols-2 gap-12 items-center">
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link to="/login" className="bg-[#3451ff] text-white px-6 py-3 rounded text-[14px] font-semibold hover:bg-[#2b41e6] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300">
              Get started
            </Link>
            <Link
              to="/login?demo=true"
      ...
      <section className="bg-[#111111] py-24 text-center px-6">
        <h2 className="text-[32px] md:text-[40px] font-bold text-white mb-6 max-w-[600px] mx-auto leading-[1.1] tracking-tight">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link to="/login" className="bg-[#3451ff] text-white px-6 py-3 rounded text-[14px] font-semibold hover:bg-[#2b41e6] hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(52,81,255,0.4)] transition-all duration-300">
              Get started
            </Link>
          </div>
      </section>
